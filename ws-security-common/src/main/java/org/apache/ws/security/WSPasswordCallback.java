...
public interface WSPasswordCallback extends Callback {
     ...
     */
    int PASSWORD_ENCRYPTOR_PASSWORD = 10;
    ...
    Element getKeyInfoReference();
    
    void setKeyInfoReference(Element keyInfoReference);
